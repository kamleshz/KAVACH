...
class EWasteService {
  ...
  async saveStorageCompliance(clientId, { rows, auditRows, additionalRows }) {
    ...
    if (complianceDoc) {
      if (updateData.storageCompliance)
        complianceDoc.storageCompliance = updateData.storageCompliance;
      if (updateData.additionalEEECompliance)
        complianceDoc.additionalEEECompliance =
          updateData.additionalEEECompliance;
      if (updateData.storageAudit)
        complianceDoc.storageAudit = updateData.storageAudit;
    } else {
      complianceDoc = new EWasteCompliance({
        clientId,
        ...updateData,
