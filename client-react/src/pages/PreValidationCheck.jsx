                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gray-50 border-b border-gray-100">
                                ...
                                <th className="p-4 font-semibold text-gray-600 text-sm uppercase tracking-wider">Validation Status</th>
                                    ...
                                    <tr key={client._id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="p-4">
                                            <span className={`px-3 py-1 rounded-full text-xs font-medium border ${
                                                client.validationStatus === 'Verified' ? 'bg-green-50 text-green-700 border-green-100' :
                                                client.validationStatus === 'Rejected' ? 'bg-red-50 text-red-700 border-red-100' :
                                                'bg-orange-50 text-orange-700 border-orange-100'
                                            }`}>
                                                {client.validationStatus === 'Verified' ? 'Verified' : 
                                                 client.validationStatus === 'Rejected' ? 'Rejected' : 
                                        ...
                                        <td className="p-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <button
                                                    onClick={() => navigate(`/dashboard/client/${client._id}/validate`)}
                                                    className="px-3 py-1.5 rounded-lg bg-green-50 text-green-700 border border-green-200 hover:bg-green-100 transition-colors flex items-center gap-2 text-sm font-medium"
