                                        ...
                                        {verificationStep === 3 && (
                                            <div className="animate-fadeIn space-y-8">
                                                ...
                                                <div>
                                                    ...
                                                    {Array.isArray(clientData?.productionFacility?.ctoProductionCapacityValidation) && clientData.productionFacility.ctoProductionCapacityValidation.length > 0 && (
                                                        <div className="mt-6 overflow-x-auto rounded-lg border border-gray-200">
                                                            <table className="w-full text-left border-collapse">
                                                                ...
                                                                <tbody className="text-sm divide-y divide-gray-100">
                                                                    {clientData.productionFacility.ctoProductionCapacityValidation.map((r, idx) => {
                                                                        const fmt = (v) => {
