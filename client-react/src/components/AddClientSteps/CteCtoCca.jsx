...
CteCtoCca.propTypes = {
    ...
    ctoAdditionalDetailRows: PropTypes.array.isRequired,
    addCtoAdditionalDetailRow: PropTypes.func.isRequired,
    handleCtoAdditionalDetailChange: PropTypes.func.isRequired,
    deleteCtoAdditionalDetailRow: PropTypes.func.isRequired,
