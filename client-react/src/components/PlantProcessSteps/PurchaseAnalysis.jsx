    ...
    return (
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
            ...
            <div className="p-5 border-b border-gray-100">
                ...
                <div>
                    <p className="text-gray-700 font-medium text-sm mb-2">Purchase / Base File</p>
                    ...
                    <div className="px-5 pb-5 space-y-5">
                        <div className="rounded-xl border border-gray-200 overflow-hidden shadow-sm [&_.ant-table-thead_th]:!bg-orange-50 [&_.ant-table-thead_th]:!font-bold [&_.ant-table-thead_th]:!text-gray-700">
                            <Table
                                ...
                                bordered
                                rowKey="key"
                                rowClassName={(record) => record.key === 'Total' ? 'bg-orange-50/50 font-semibold' : ''}
                                expandable={{
                                    expandedRowRender,
